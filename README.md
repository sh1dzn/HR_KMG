...
AI-модуль для работы с целями сотрудников: оценка качества формулировок по SMART, генерация целей по контексту сотрудника и внутренних документов, а также аналитический дашборд по качеству целеполагания.
...
- без OpenAI часть сценариев работает через эвристику, а не через полноценную AI-оценку
- production build frontend сейчас собирается, но основной JS bundle крупный; позже можно сделать code splitting

## Дата актуализации

README актуализирован под состояние проекта на 12 марта 2026 года.
